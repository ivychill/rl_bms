...
class FlyEnv(object):
    ...
    def __init__(self):
        ...
        self.RANGE_ROLL = (60*math.pi/180, 96*math.pi/180)
        self.RANGE_SPEED_VECTOR = (-20*math.pi/180, 20*math.pi/180)
    ...
    def start_fly(self):
        ...
        for index_i in range(4):
            ...
            fly_state[index_i * 4 + 2] = (fly_state[index_i * 4 + 2] - self.RANGE_ROLL[0])/(self.RANGE_ROLL[1]- self.RANGE_ROLL[0])
            fly_state[index_i * 4 + 3] = (fly_state[index_i * 4 + 3] - self.RANGE_SPEED_VECTOR[0]) / (self.RANGE_SPEED_VECTOR[1] - self.RANGE_SPEED_VECTOR[0])
    ...
    def get_state(self):
        ...
        return np.asarray([normalized_altitude, normalized_speed, normalized_roll, normalized_speed_vector])
